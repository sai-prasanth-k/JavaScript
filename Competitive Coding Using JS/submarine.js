...
class WeaponUnit extends Submarine {
  ...
  constructor(torpedos, torpedosLaunched){
      super();
      this.torpedos = torpedos;
      this.torpedosLaunched = torpedosLaunched;
  }
  
  fireTorpedos() {
      this.torpedos -= this.torpedosLaunched;
      console.log(`${this.torpedosLaunched} Torpedos Fired, ${this.torpedos} Left`);
  }
